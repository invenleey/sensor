...
/**
 * A numerical verification for CRC16 ModBus
 * @param target a byte array which to be verified
 * @param pattern Matching parameter for verification.It must be a 16 bit parameter.
